  ...
  return (
    <div className='w-5/6 lg:w-4/6 h-auto shadow-xl shadow-gray-400 rounded-xl flex flex-col p-4 mb-16'>
        <div className='flex-col justify-between sm:flex sm:flex-row'>
            ...
            <button className="px-4 py-2 sm:py-0 text-sm rounded-full text-slate-100 bg-sky-700 hover:bg-sky-600 mt-2 sm:mt-0">
                <Link href={`/recruiter/${props.authorId}/jobs/${props.id}`}>{`Applicants (${props.applicants.length})`}</Link>
            </button>
        </div>
